      ...
      {showPrompt && (
        <StyledPromptContainer>
          ...
          >
            ...
            <SwitchButton checked={i18n.language === 'es'} onChange={handleLanguageChange} />
          </StyledContainer>
          <StyledContainer onClick={handleClick} alignItems={'center'}>
            <StyledP primary>{`${t('buttons.logout')} @${user?.username}`}</StyledP>
          </StyledContainer>
        </StyledPromptContainer>
      )}
      <Modal
        ...
        acceptButton={
          <Button buttonType={ButtonType.FOLLOW} text={t('buttons.logout')} size={'MEDIUM'} onClick={handleLogout} />
        }
